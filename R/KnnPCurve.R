...
#' @param xvar a vector with column number of non circular features
#' @param xvar.circ a vector with column number of circular features
#' @param yvar column number of target
